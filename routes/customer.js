...
router.post('/orders/checkout', async function (req, res, next) {
  ...
  console.log(req);
  try {
    const chkout = await dynamo.putInTable(ddb, ddbQueries.putOrderSummary(order_id, customer_id, restaurant_id, total_price, taxes, surge_fee, total_tip, express_delivery, coupon_used, createdAt));
